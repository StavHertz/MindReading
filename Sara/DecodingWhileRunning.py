# -*- coding: utf-8 -*-
"""
Comparison of decoding while mouse is running vs not running
...
from neuropixel_decoding import create_test_train_running_data, get_all_frames
from neuropixel_running import get_running_speed
#%%
...
# Natural scene images to
s_frames1 = all_stim_frames
s_frames2 = all_stim_frames

# Nice name for plotting
stim_names = ['Static vs. Static']

stim_types1 = ['static_gratings']
stim_types2 = stim_types1

run_types = [True, False]
#%%
st1 = 'static_gratings'  # tim_types1[stim_ind]
